...
export class ingredientTable1630371552689 implements MigrationInterface {
    name = 'ingredientTable1630371552689'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "category" ("id" SERIAL NOT NULL, "name" text NOT NULL, "description" character varying(100), CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "recipe_details" ("id" SERIAL NOT NULL, "preparation" text NOT NULL, "description" character varying(100), CONSTRAINT "PK_5a3b10a3f9860b528c53db0d0cb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "recipe" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "urlImage" text, "category_id" integer NOT NULL, "user_id" integer NOT NULL, "details_id" integer NOT NULL, CONSTRAINT "REL_c1b4e81bf69aa6e8f3a14c4c2f" UNIQUE ("category_id"), CONSTRAINT "REL_385770dfbf5b275c495dd29854" UNIQUE ("user_id"), CONSTRAINT "REL_5a3b10a3f9860b528c53db0d0c" UNIQUE ("details_id"), CONSTRAINT "PK_e365a2fedf57238d970e07825ca" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "ingredients_recipes" ADD CONSTRAINT "FK_4e130cc5b67a9d0574a857292f6" FOREIGN KEY ("ingredientsId") REFERENCES "ingredients"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
